...
void CrateApp::DrawScene()
{
	...
	md3dImmediateContext->PSSetShaderResources(0, 1, mTextureSrvs["wood"].GetAddressOf());
...
{
	HR(CreateDDSTextureFromFile(md3dDevice.Get(), L"../../Textures/WoodCrate02.dds",
		nullptr, mTextureSrvs["wood"].GetAddressOf()));
}
